...
var require_sidebar = __commonJS({
  "sidebar.js"(exports) {
    ...
    const History = createLucideIcon$1("History", [
      [
        "path",
    ...
    const useHistory = () => {
      ...
      const getStartTime = (range) => {
        ...
        switch (range) {
          case "1h":
            return now - oneHour;
          case "24h":
            return now - oneHour * 24;
          case "7d":
            return now - oneHour * 24 * 7;
          case "30d":
            return now - oneHour * 24 * 30;
          default:
            return now - oneHour * 24;
        }
      };
      const loadHistory = (range = "24h") => __async(exports, null, function* () {
        setLoading(true);
        try {
          const startTime = getStartTime(range);
          if (typeof chrome !== "undefined" && chrome.history) {
            chrome.history.search(
              { text: "", startTime, maxResults: 100 },
              (items) => {
                setHistory(items || []);
                setLoading(false);
              }
      ...
      const summarizeHistory = (historyItems) => __async(exports, null, function* () {
        ...
        setSummarizing(true);
        try {
          const historyText = historyItems.map((item) => `${item.title || "Untitled"} - ${item.url}`).join("\n");
          const response = yield fetch("http://localhost:5000/summarize", {
            method: "POST",
    ...
    const useChat = () => {
      ...
      const getCurrentHistory = () => __async(exports, null, function* () {
        return new Promise((resolve) => {
          if (typeof chrome !== "undefined" && chrome.history) {
            const now = Date.now();
            const startTime = now - 1e3 * 60 * 60 * 24;
            chrome.history.search(
              { text: "", startTime, maxResults: 20 },
              (items) => {
                resolve(items || []);
              }
            );
      ...
      const sendMessage = (message) => __async(exports, null, function* () {
        ...
        try {
          const historyContext = yield getCurrentHistory();
          const response = yield fetch("http://localhost:5000/chat", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              message,
      ...
      const clearChat = () => __async(exports, null, function* () {
        setMessages([]);
        try {
          yield fetch(`http://localhost:5000/chat/${sessionIdRef.current}`, {
            method: "DELETE"
          });
        } catch (error) {
      ...
      const analyzeHistory = () => __async(exports, null, function* () {
        const historyContext = yield getCurrentHistory();
        ...
        yield sendMessage(analysisPrompt);
      });
      return {
        messages,
        loading,
    ...
    const ChatTab = () => {
      ...
      const handleSubmit = (e) => __async(exports, null, function* () {
        ...
        if (!inputValue.trim() || loading)
          return;
        yield sendMessage(inputValue.trim());
        setInputValue("");
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border-b border-gray-200 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold text-black", children: "History Assistant" }),
